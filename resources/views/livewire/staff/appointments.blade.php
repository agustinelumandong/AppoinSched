      ...
      <table class="table table-zebra w-full">
        ...
        @endphp
          ...
          <td>
            ...
            <button wire:click="openShowAppointmentModal({{ $appointment->id }})" class="btn btn-sm btn-outline">
              <i class="bi bi-eye me-1"></i>View
            </button>
            <button wire:click="openEditAppointmentModal({{ $appointment->id }})" class="btn btn-sm btn-primary">
