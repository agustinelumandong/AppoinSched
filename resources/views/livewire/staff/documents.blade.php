...
<div>
      ...
      <table class="table flux-table w-full">
        ...
        <tbody>
          @forelse($documentRequests as $documentRequest)
            ...
            {{ $documentRequest->details->first_name }} {{ $documentRequest->details->last_name }}
            <span
  ...
  @if($documentRequest)
    ...
    <div class="modal-dialog modal-xl">
      ...
      <div class="btn-group">
      <button wire:click="updateDocumentStatus({{ $documentRequest->id }}, 'approved')" class="btn btn-success">
        <i class="bi bi-check-circle me-1"></i>Approve
      </button>
      <button wire:click="updateDocumentStatus({{ $documentRequest->id }}, 'rejected')" class="btn btn-danger">
        <i class="bi bi-x-circle me-1"></i>Reject
      </button>
      <button wire:click="updateDocumentStatus({{ $documentRequest->id }}, 'completed')" class="btn btn-primary">
