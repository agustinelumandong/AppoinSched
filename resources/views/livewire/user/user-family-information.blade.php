<div>
    ...
    <div class="flux-card p-6">
        ...
        <div>
            ...
            <div class="flex flex-row md:flex-col gap-4 mb-4">
                <div class="w-full md:w-1/3">
                    <label for="mother_last_name" class="block text-xs font-medium mb-1">Mother's Maiden Last
                        Name</label>
                ...
                <div class="w-full md:w-1/3">
                    <label for="mother_first_name" class="block text-xs font-medium mb-1">Mother's Maiden First
                        Name</label>
                    <input class="flux-form-control md:col-span-3 w-full " type="text"
                ...
                <div class="w-full md:w-1/3">
                    <label for="mother_middle_name" class="block text-xs font-medium mb-1">Mother's Maiden Middle
                        Name</label>
                    <input class="flux-form-control md:col-span-3 w-full " type="text"
