<x-modal id="edit-service" title="Edit Service" size="max-w-2xl">
    <form wire:submit.prevent="updateService" enctype="multipart/form-data">
        <input type="hidden" wire:model="serviceId">
    ...
    <x-slot name="footer">
        <div class="gap-2 ">
            ...
            <button type="submit" class="btn btn-primary ml-2" wire:click="updateService" wire:loading.attr="disabled">
