<div class="px-5 py-2 mt-5">
  <div class="flex flex-col gap-4">
    ...
    @enderror
      ...
      <input type="radio" id="school_requirement" name="purpose" value="school_requirement" wire:model.live="purpose"
        hidden />
      ...
      <input type="radio" id="employment" name="purpose" value="employment" wire:model.live="purpose" hidden />
      ...
      <input type="radio" id="government_id" name="purpose" value="government_id" wire:model.live="purpose" hidden />
      ...
      <input type="radio" id="hospital_use" name="purpose" value="hospital_use" wire:model.live="purpose" hidden />
      ...
      @if ($purpose === 'others')
      <div class="mt-4">
      <input type="text" placeholder="Please specify purpose" class="flux-form-control" wire:model="purpose_others" />
    ...
    @else
      ...
      <div class="flex flex-col gap-2 w-full">
        <input type="radio" id="legal_proceedings" name="purpose" value="Legal Proceedings" wire:model.live="purpose"
        hidden />
        ...
        <input type="radio" id="insurance_claims" name="purpose" value="Insurance Claims" wire:model.live="purpose"
        hidden />
        ...
        <input type="radio" id="property_transfer" name="purpose" value="Property Transfer" wire:model.live="purpose"
        hidden />
        ...
        <input type="radio" id="veterans_benefits" name="purpose" value="Veterans Benefits" wire:model.live="purpose"
        hidden />
        ...
        <input type="radio" id="personal_records" name="purpose" value="Personal Records" wire:model.live="purpose"
        hidden />
        ...
        <input type="radio" id="other_purpose" name="purpose" value="Other" wire:model.live="purpose" hidden />
