      ...
      <div class="flex flex-col gap-6 w-full" wire:loading.remove>
        ...
        @enderror
          ...
          <div class="w-1/7">
            ...
            <select class="flux-form-control md:col-span-1 w-full" wire:model="suffix" name="suffix" id="suffix">
        ...
        @enderror
          ...
          <div>
            ...
            <input class="flux-form-control" name="email" type="email" wire:model="email" placeholder="Email"
            id="email">
            @error('email')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          ...
          <div>
            ...
            <input class="flux-form-control" type="text" name="phone" wire:model="phone" placeholder="Contact No"
            id="phone">
            @error('phone')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          ...
          <div>
            <div class="flex flex-row gap-4" role="radiogroup" aria-labelledby="sex-at-birth-label">
            <span id="sex-at-birth-label" class="sr-only">Sex at Birth</span> <label
              class="inline-flex items-center cursor-pointer text-xs">
              <input type="radio" name="sex_at_birth" class="flux-radio" wire:model="sex_at_birth" value="Male"
              aria-label="Sex at Birth: Male">
              <span class="ml-2 font-medium">Male</span>
            </label>
            <label class="inline-flex items-center cursor-pointer text-xs">
              <input type="radio" name="sex_at_birth" class="flux-radio" wire:model="sex_at_birth" value="Female"
              aria-label="Sex at Birth: Female">
        ...
        @enderror
          ...
          <div>
            ...
            Birth</label>
            <input class="flux-form-control" type="date" wire:model="date_of_birth" placeholder="Date of Birth"
        ...
        @enderror
          ...
          <div>
            ...
            Birth</label>
            <input class="flux-form-control" type="text" wire:model="place_of_birth" placeholder="Place of Birth"
        ...
        @enderror
          ...
          <div>
            ...
            Status</label>
            <select class="flux-form-control" wire:model="civil_status" name="civil_status" id="civil_status">
        ...
        @enderror
          ...
          <div>
            ...
            <input class="flux-form-control" type="text" wire:model="religion" placeholder="Religion" name="religion"
            id="religion">
            @error('religion')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          ...
          <div>
            ...
            <input class="flux-form-control" type="text" wire:model="nationality" placeholder="Nationality"
        ...
        @enderror
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <input class="flux-form-control" type="text" wire:model="region" name="region" placeholder="Region"
              id="region">
            @error('region')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
        ...
        @enderror
            ...
            <input class="flux-form-control" type="text" wire:model="street" placeholder="Street" name="street"
              id="street">
            @error('street')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
            ...
            <input class="flux-form-control" type="text" wire:model="zip_code" placeholder="Zip Code"
        ...
        <div class="flux-card p-6">
          ...
          placeholder="Last Name" name="father_last_name" id="father_last_name">
        ...
        @enderror
          ...
          placeholder="First Name" name="father_first_name" id="father_first_name">
        ...
        @enderror
          ...
          placeholder="Middle Name" name="father_middle_name" id="father_middle_name">
        ...
        @enderror
          ...
          <div class="flex flex-row md:flex-col gap-4 mb-4">
          <div class="w-full md:w-1/3">
          <label for="father_birthdate" class="block text-xs font-medium mb-1">Father's
          Birthdate</label>
          <input class="flux-form-control" type="date" wire:model="father_birthdate"
          placeholder="Father's Birthdate" name="father_birthdate" id="father_birthdate">
          @error('father_birthdate')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div class="w-full md:w-1/3">
          <label for="father_nationality" class="block text-xs font-medium mb-1">Father's
          Nationality</label>
          <input class="flux-form-control" type="text" wire:model="father_nationality"
          placeholder="Father's Nationality" name="father_nationality" id="father_nationality">
          @error('father_nationality')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div class="w-full md:w-1/3">
          <label for="father_religion" class="block text-xs font-medium mb-1">Father's
          Religion</label>
          <input class="flux-form-control" type="text" wire:model="father_religion" placeholder="Father's Religion"
          name="father_religion" id="father_religion">
          @error('father_religion')
          <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div class="w-full md:w-1/3">
          <label for="father_contact_no" class="block text-xs font-medium mb-1">Father's
          Contact
          No</label>
          <input class="flux-form-control" type="text" wire:model="father_contact_no"
          placeholder="Father's Contact No" name="father_contact_no" id="father_contact_no">
        ...
        @enderror
          ...
          <select class="flux-form-control md:col-span-1 w-full" wire:model="mother_suffix" name="mother_suffix"
          id="mother_suffix">
          <option value="">Suffix</option>
          <option value="N/A">N/A</option>
          <option value="Jr.">Jr.</option>
        ...
        <div class="flex flex-row md:flex-col gap-4 mb-4">
          ...
          Name</label>
          <input class="flux-form-control md:col-span-3 w-full" type="text" wire:model="spouse_last_name"
          placeholder="Last Name" name="spouse_last_name" id="spouse_last_name">
        ...
        @enderror
          ...
          Name</label>
          <input class="flux-form-control md:col-span-3 w-full" type="text" wire:model="spouse_first_name"
          placeholder="First Name" name="spouse_first_name" id="spouse_first_name">
        ...
        @enderror
          ...
          Name</label>
          <input class="flux-form-control md:col-span-3 w-full" type="text" wire:model="spouse_middle_name"
          placeholder="Middle Name" name="spouse_middle_name" id="spouse_middle_name">
        ...
        @enderror
          ...
          <select class="flux-form-control md:col-span-1 w-full" wire:model="spouse_suffix" name="spouse_suffix"
          id="spouse_suffix">
          <option value="">Suffix</option>
          <option value="N/A">N/A</option>
          <option value="Jr.">Jr.</option>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
          <label for="spouse_birthdate" class="block text-xs font-medium mb-1">Spouse's
          Birthdate</label>
          <input class="flux-form-control" type="date" wire:model="spouse_birthdate"
          placeholder="Spouse's Birthdate" name="spouse_birthdate" id="spouse_birthdate">
          @error('spouse_birthdate')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div>
          <label for="spouse_nationality" class="block text-xs font-medium mb-1">Spouse's
          Nationality</label>
          <input class="flux-form-control" type="text" wire:model="spouse_nationality"
          placeholder="Spouse's Nationality" name="spouse_nationality" id="spouse_nationality">
          @error('spouse_nationality')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div>
          <label for="spouse_religion" class="block text-xs font-medium mb-1">Spouse's
          Religion</label>
          <input class="flux-form-control" type="text" wire:model="spouse_religion"
          placeholder="Spouse's Religion" name="spouse_religion" id="spouse_religion">
          @error('spouse_religion')
        <span class="text-red-500 text-sm">{{ $message }}</span>
        @enderror
          </div>
          <div>
          <label for="spouse_contact_no" class="block text-xs font-medium mb-1">Spouse's
          Contact
          No</label>
          <input class="flux-form-control" type="text" wire:model="spouse_contact_no"
          placeholder="Spouse's Contact No" name="spouse_contact_no" id="spouse_contact_no">
    ...
    @else
      ...
      @enderror
        ...
        <div class="flex flex-row md:flex-col gap-4 mb-4">
          ...
          <input class="flux-form-control" type="date" wire:model="death_date" placeholder="Death Date"
      ...
      @enderror
          ...
          <input class="flux-form-control" type="time" wire:model="death_time" placeholder="Death Time"
            name="death_time" id="death_time">
          @error('death_time')
        <span class="text-red-500 text-sm">{{ $message }}</span>
      @enderror
          </div>
