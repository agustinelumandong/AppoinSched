  ...
  <div>
    ...
    <div>
      ...
      <input class="flux-form-control mb-4 @if($editPersonDetails === false) bg-gray-100 @endif" type="text"
        ...
        @if($to_whom === 'myself' && $editPersonDetails === false) disabled @endif @if($same_as_personal_address) disabled
    @endif>
    ...
    <div>
      ...
      @endforeach
        ...
        <div class="flex flex-col">
          ...
          <input id="street" class="flux-form-control @if($editPersonDetails === false) bg-gray-100 @endif" type="text"
            wire:model="street" placeholder="Street" @if($to_whom === 'myself' && $editPersonDetails === false) disabled
      @endif @if($same_as_personal_address) disabled @endif>
          <span class="text-xs text-gray-500 mt-1">Put N/A if not applicable</span>
          <span class="text-xs text-gray-500 mt-1">Required</span>
        </div>
        <div class="flex flex-col">
