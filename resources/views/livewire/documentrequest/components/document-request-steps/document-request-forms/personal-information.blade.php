    ...
    <div class="flux-card p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <input class="flux-form-control" name="email" type="email" wire:model="email" placeholder="Email" id="email">
        ...
        <div>
          ...
          <select class="flux-form-control w-full" wire:model="sex_at_birth" name="sex_at_birth" id="sex_at_birth"
