  ...
  <div x-show="open" @click.away="open = false" x-transition:enter="transition ease-out duration-200"
    ...
    <div class="p-4 border-b border-gray-200 dark:border-gray-700">
      <div class="flex items-center justify-between">
        ...
        @if($unreadCount > 0)
      <button wire:click="$dispatch('markAllAsRead')"
    ...
    <div class="max-h-96 overflow-y-auto">
      ...
      <div
      class="p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 {{ $notification->read_at ? '' : 'bg-blue-50 dark:bg-blue-900/20' }}">
      ...
      @if(!$notification->read_at)
      <button wire:click="$dispatch('markAsRead', { id: '{{ $notification->id }}' })"
