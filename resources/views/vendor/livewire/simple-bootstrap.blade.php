...
<div class="flux-pagination px-3">
            ...
            <div class="d-none d-sm-flex align-items-center justify-content-between w-100">
                <div class="flex-shrink-0">
                    <p class="small text-muted d-flex align-items-center mb-0">
                        {!! __('Showing') !!}
                        <span class="fw-semibold mx-1">{{ $paginator->firstItem() }}</span>
                        {!! __('to') !!}
                        <span class="fw-semibold mx-1">{{ $paginator->lastItem() }}</span>
                        {!! __('of') !!}
                        <span class="fw-semibold mx-1">{{ $paginator->total() }}</span>
                        {!! __('results') !!}
                    </p>
                </div>
