...
namespace Livewire {
    ...
    class Component {
         ...
         * @static
         */
        public static function testStep($stepClass, $state = [])
        {
            return \Livewire\Component::testStep($stepClass, $state);
        }
...
namespace Livewire\Features\SupportTesting {
    ...
    class Testable {
        ...
        {
            return \Livewire\Features\SupportTesting\Testable::emitEvents();
        }
        ...
        {
            return \Livewire\Features\SupportTesting\Testable::getStepState($step);
        }
