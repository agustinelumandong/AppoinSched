...
class AdminEventNotification extends Notification
{
    ...
    protected function generateSummaryMessage(): string
    {
        return match ($this->event) {
            ...
            AdminNotificationEvent::UserPayedDocumentRequest => 'A user has paid for a document request.',
            ...
            AdminNotificationEvent::UserAppointmentCancelled => 'A user has cancelled an appointment.',
            AdminNotificationEvent::UserAppointmentRescheduled => 'A user has rescheduled an appointment.',
            AdminNotificationEvent::UserAppointmentCompleted => 'A user has completed an appointment.',
        };
    }
}
